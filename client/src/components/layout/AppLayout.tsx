...
export function AppLayout() {
  ...
  return (
    <div className="flex h-screen">
      <ServerSidebar />
      <ChannelSidebar />
      <div className="flex flex-1 flex-col bg-bg-dark theme-ink-wash">
        <Routes>
          <Route
            ...
            element={
              <div className="flex flex-1 items-center justify-center text-text-muted">
                <div className="text-center">
                  <h2 className="theme-heading mb-2 text-2xl font-bold text-text-secondary font-[var(--font-heading)] tracking-[var(--heading-tracking)]">Welcome to Homestead</h2>
